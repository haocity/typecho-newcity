...
$(document).ready(function() {
    ...
    var ele = '<div class="changerimg" onmouseenter="showoneimg()" onmouseleave="hideoneimg()" onclick="showoneimg()"><img  id="oneimgmenuimg" src="https://www.haotown.cn/usr/themes/newcity/img/imgmenu.png" style="width: 70px;"><div id="oneimgmenu"><div class="hcset"><p><input type="checkbox" id="hccolorswitch" onclick="hcswitch()" >背景颜色<input type="color" id="hccolor" value="#ffffff" /> </p><p id="hctmd" class="range">透明度 <input type="range" name="points" min="0" max="100"  id="hcsetrange" onmouseup="hcchangerrange()" onmouseout="hcchangerrange()" style="width: 70px;"/> </p></div><img src="https://www.haotown.cn/usr/themes/newcity/img/imgdown.png" title="下载/评论图片" style="width: 70px;"   onclick="DownImg()"><img src="https://www.haotown.cn/usr/themes/newcity/img/imgchanger.png" title="更换图片" style="width: 70px;" onclick="ChangerImg()"></div></div>';
    warp.innerHTML = ele;
